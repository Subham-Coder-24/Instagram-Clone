...
export const likeReducer = createReducer(initialState, (builder) => {
  builder
    ...
    //------------------------------------------------
    .addCase("storyCreateRequest", (state) => {
      state.loading = true;
    })
    .addCase("storyCreateSuccess", (state, action) => {
      state.loading = false;
      state.message = action.payload;
    })
    .addCase("storyCreateFailure", (state, action) => {
      state.loading = false;
      state.error = action.payload;
    })
    //------------------------------------------------
...
export const storyReducer = createReducer(initialState, (builder) => {
  builder
    .addCase("allStoryRequest", (state) => {
      state.loading = true;
    })
    .addCase("allStorySuccess", (state, action) => {
      state.loading = false;
      state.story = action.payload;
    })
    .addCase("allStoryFailure", (state, action) => {
      state.loading = false;
      state.error = action.payload;
    })
    .addCase("clearErrors", (state) => {
